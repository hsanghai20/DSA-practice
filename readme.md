# All important questions for interviews and placements
...
Topic | Link 
------------------- | ---------------------
Linked List Contain Cycle | https://leetcode.com/problems/linked-list-cycle-ii/
...
Topic | Link 
------------------- | ---------------------
Minimum Number Of Coins(Indian currency array) | https://practice.geeksforgeeks.org/problems/-minimum-number-of-coins/0
...
Largest Subarray sum 0 | https://practice.geeksforgeeks.org/problems/largest-subarray-with-0-sum/1
Longest substring without repeat | https://leetcode.com/problems/longest-substring-without-repeating-characters/
Subarray sum equal k |  https://leetcode.com/problems/subarray-sum-equals-k/
...
Topic | Link 
------------------- | ---------------------
Add Two No | https://leetcode.com/problems/add-two-numbers/
...
Delete Cycle And Remove |  https://leetcode.com/problems/linked-list-cycle-ii/
